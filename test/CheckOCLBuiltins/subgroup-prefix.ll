...
; CHECK-SPIRV: Name [[fname1:[0-9]+]] "_Z28sub_group_fetch_and_add_uint32Pii"
; CHECK-SPIRV-DAG: Name [[fname2:[0-9]+]] "_Z28sub_group_fetch_and_sub_uint32Pii"
; CHECK-SPIRV-DAG: FunctionCall {{[0-9]+}} {{[0-9]+}} [[fname2]] {{[0-9]+}} {{[0-9]+}}
; CHECK-SPIRV-DAG: FunctionCall {{[0-9]+}} {{[0-9]+}} [[fname1]] {{[0-9]+}} {{[0-9]+}}

; CHECK-LLVM: call spir_func i32 @_Z28sub_group_fetch_and_sub_uint32Pii
; CHECK-LLVM-DAG: call spir_func i32 @_Z28sub_group_fetch_and_add_uint32Pii
; Function Attrs: mustprogress norecurse nounwind
define weak_odr dso_local spir_kernel void @_ZTSN4test_ocl_builtin4(ptr addrspace(4) noundef %arrayidx.i311) {
entry:
     %call.i312 = call spir_func noundef i32 @_Z28sub_group_fetch_and_sub_uint32Pii(ptr addrspace(4) noundef %arrayidx.i311, i32 noundef 1)
     %call.i313 = call spir_func noundef i32 @_Z28sub_group_fetch_and_add_uint32Pii(ptr addrspace(4) noundef %arrayidx.i311, i32 noundef 1)
     ret void
}

; Function Attrs: convergent inlinehint mustprogress norecurse nounwind
define linkonce_odr dso_local spir_func noundef i32 @_Z28sub_group_fetch_and_sub_uint32Pii(ptr addrspace(4) noundef %p, i32 noundef %x) {
entry:
...
declare dso_local spir_func noundef i32 @_Z28sub_group_fetch_and_add_uint32Pii(ptr addrspace(4) noundef %p, i32 noundef %x)

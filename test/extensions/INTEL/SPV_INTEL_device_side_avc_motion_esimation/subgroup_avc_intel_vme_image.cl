...
// CHECK-LLVM: @foo(target("spirv.Image", void, 1, 0, 0, 0, 0, 0, 0) %[[SrcImg:.*]], target("spirv.Image", void, 1, 0, 0, 0, 0, 0, 0) %[[RefImg:.*]], target("spirv.Sampler") %[[Sampler:.*]], ptr %[[ImePayload:.*]], ptr %[[ImeSRefIn:.*]], ptr %[[ImeDRefIn:.*]], ptr %[[RefPayload:.*]], ptr %[[SicPayload:.*]])
...
// CHECK-LLVM: call spir_func ptr @_Z54intel_sub_group_avc_ime_evaluate_with_single_reference14ocl_image2d_roS_11ocl_sampler37ocl_intel_sub_group_avc_ime_payload_t(target("spirv.Image", void, 1, 0, 0, 0, 0, 0, 0) %[[SrcImg]], target("spirv.Image", void, 1, 0, 0, 0, 0, 0, 0) %[[RefImg]], target("spirv.Sampler") %[[Sampler]], ptr %[[ImePayload]])
...
// CHECK-LLVM: call spir_func ptr @_Z52intel_sub_group_avc_ime_evaluate_with_dual_reference14ocl_image2d_roS_S_11ocl_sampler37ocl_intel_sub_group_avc_ime_payload_t(target("spirv.Image", void, 1, 0, 0, 0, 0, 0, 0) %[[SrcImg]], target("spirv.Image", void, 1, 0, 0, 0, 0, 0, 0) %[[RefImg]], target("spirv.Image", void, 1, 0, 0, 0, 0, 0, 0) %[[RefImg]], target("spirv.Sampler") %[[Sampler]], ptr %[[ImePayload]])
...
// CHECK-LLVM: call spir_func ptr @_Z64intel_sub_group_avc_ime_evaluate_with_single_reference_streamout14ocl_image2d_roS_11ocl_sampler37ocl_intel_sub_group_avc_ime_payload_t(target("spirv.Image", void, 1, 0, 0, 0, 0, 0, 0) %[[SrcImg]], target("spirv.Image", void, 1, 0, 0, 0, 0, 0, 0) %[[RefImg]], target("spirv.Sampler") %[[Sampler]], ptr %[[ImePayload]])
...
// CHECK-LLVM: call spir_func ptr @_Z62intel_sub_group_avc_ime_evaluate_with_dual_reference_streamout14ocl_image2d_roS_S_11ocl_sampler37ocl_intel_sub_group_avc_ime_payload_t(target("spirv.Image", void, 1, 0, 0, 0, 0, 0, 0) %[[SrcImg]], target("spirv.Image", void, 1, 0, 0, 0, 0, 0, 0) %[[RefImg]], target("spirv.Image", void, 1, 0, 0, 0, 0, 0, 0) %[[RefImg]], target("spirv.Sampler") %[[Sampler]], ptr %[[ImePayload]])
...
// CHECK-LLVM: call spir_func ptr @_Z54intel_sub_group_avc_ref_evaluate_with_single_reference14ocl_image2d_roS_11ocl_sampler37ocl_intel_sub_group_avc_ref_payload_t(target("spirv.Image", void, 1, 0, 0, 0, 0, 0, 0) %[[SrcImg]], target("spirv.Image", void, 1, 0, 0, 0, 0, 0, 0) %[[RefImg]], target("spirv.Sampler") %[[Sampler]], ptr %[[RefPayload]])
...
// CHECK-LLVM: call spir_func ptr @_Z52intel_sub_group_avc_ref_evaluate_with_dual_reference14ocl_image2d_roS_S_11ocl_sampler37ocl_intel_sub_group_avc_ref_payload_t(target("spirv.Image", void, 1, 0, 0, 0, 0, 0, 0) %[[SrcImg]], target("spirv.Image", void, 1, 0, 0, 0, 0, 0, 0) %[[RefImg]], target("spirv.Image", void, 1, 0, 0, 0, 0, 0, 0) %[[RefImg]], target("spirv.Sampler") %[[Sampler]], ptr %[[RefPayload]])
...
// CHECK-LLVM: call spir_func ptr @_Z53intel_sub_group_avc_ref_evaluate_with_multi_reference14ocl_image2d_roj11ocl_sampler37ocl_intel_sub_group_avc_ref_payload_t(target("spirv.Image", void, 1, 0, 0, 0, 0, 0, 0) %[[SrcImg]], i32 0, target("spirv.Sampler") %[[Sampler]], ptr %[[RefPayload]])
...
// CHECK-LLVM: call spir_func ptr @_Z53intel_sub_group_avc_ref_evaluate_with_multi_reference14ocl_image2d_rojh11ocl_sampler37ocl_intel_sub_group_avc_ref_payload_t(target("spirv.Image", void, 1, 0, 0, 0, 0, 0, 0) %[[SrcImg]], i32 0, i8 0, target("spirv.Sampler") %[[Sampler]], ptr %[[RefPayload]])
...
// CHECK-LLVM: call spir_func ptr @_Z54intel_sub_group_avc_sic_evaluate_with_single_reference14ocl_image2d_roS_11ocl_sampler37ocl_intel_sub_group_avc_sic_payload_t(target("spirv.Image", void, 1, 0, 0, 0, 0, 0, 0) %[[SrcImg]], target("spirv.Image", void, 1, 0, 0, 0, 0, 0, 0) %[[RefImg]], target("spirv.Sampler") %[[Sampler]], ptr %[[SicPayload]])
...
// CHECK-LLVM: call spir_func ptr @_Z52intel_sub_group_avc_sic_evaluate_with_dual_reference14ocl_image2d_roS_S_11ocl_sampler37ocl_intel_sub_group_avc_sic_payload_t(target("spirv.Image", void, 1, 0, 0, 0, 0, 0, 0) %[[SrcImg]], target("spirv.Image", void, 1, 0, 0, 0, 0, 0, 0) %[[RefImg]], target("spirv.Image", void, 1, 0, 0, 0, 0, 0, 0) %[[RefImg]], target("spirv.Sampler") %[[Sampler]], ptr %[[SicPayload]])
...
// CHECK-LLVM: call spir_func ptr @_Z53intel_sub_group_avc_sic_evaluate_with_multi_reference14ocl_image2d_roj11ocl_sampler37ocl_intel_sub_group_avc_sic_payload_t(target("spirv.Image", void, 1, 0, 0, 0, 0, 0, 0) %[[SrcImg]], i32 0, target("spirv.Sampler") %[[Sampler]], ptr %[[SicPayload]])
...
// CHECK-LLVM: call spir_func ptr @_Z53intel_sub_group_avc_sic_evaluate_with_multi_reference14ocl_image2d_rojh11ocl_sampler37ocl_intel_sub_group_avc_sic_payload_t(target("spirv.Image", void, 1, 0, 0, 0, 0, 0, 0) %[[SrcImg]], i32 0, i8 0, target("spirv.Sampler") %[[Sampler]], ptr %[[SicPayload]])
...
// CHECK-LLVM: call spir_func ptr @_Z36intel_sub_group_avc_sic_evaluate_ipe14ocl_image2d_ro11ocl_sampler37ocl_intel_sub_group_avc_sic_payload_t(target("spirv.Image", void, 1, 0, 0, 0, 0, 0, 0) %[[SrcImg]], target("spirv.Sampler") %[[Sampler]], ptr %[[SicPayload]])
